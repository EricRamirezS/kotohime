...
package com.ericramirezs.kotohimebot.external.api.tracemoe;
...
public class TraceMoeService {
    ...
    private static TraceMoeService instance;

    public static TraceMoeService getInstance(){
        return instance;
    }

    @Value("${api.tracemoe.baseurl}")
